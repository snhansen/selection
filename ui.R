...
ui <- fluidPage(
  title = "Selection bias in linear regression ",
  theme = shinytheme("lumen"),
  titlePanel(h1("Selection bias in linear regression",
                align = "center")),
  fluidRow(
  ...
  bsTooltip(id = "xrange",
            title = "Select only observations with an X-value in this range",
            placement = "right",
            trigger = "hover"),
  bsTooltip(id = "yrange",
            title = "Select only observations with a Y-value in this range",
            placement = "right",
            trigger = "hover")
)